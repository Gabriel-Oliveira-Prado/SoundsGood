    ...
    <head>
        ...
        <title>SoundsGood - Sons para Tranquilidade</title>
        ...
        <link rel="stylesheet" href="/css/SoundsGood.css">
    </head>
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                    <ul class="navbar-nav custom-nav-links mx-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#beneficios">Serviços</a></li>
                    </ul>
                    <a class="btn btn-cta btn-entrar d-none d-lg-inline-block" href="/Login">
                        Entrar
                    </a>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center min-vh-100">
                    <div class="col-lg-6">
                        ...
                        <a href="/Atividades" class="btn btn-hero btn-lg">
            ...
            <div class="container reveal">
                ...
                <div class="pricing-grid">
                    ...
                    <div class="pricing-card " data-plan="gratuito">
                        ...
                        <a href="/Atividades" class="btn btn-pricing-secondary">Explorar</a>
                    </div>
